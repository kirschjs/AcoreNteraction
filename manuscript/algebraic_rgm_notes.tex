...
\item For $A\gg1$, the pair terms ($\eta_1,\zeta_2$) grow linearly with $A$, while the triplet terms
($\eta_{2,3},\zeta_{3,4}$) increase in magnitude quadratically in $A$.
...
\hline\hline
$i$ & $\eta_i$~[MeV] & $\kappa_i$ & & \\
1   & $8~C_0^\Lambda~\frac{A\mprime}{\left(4+\frac{A\mprime}{A}\frac{\Lambda^2}{a}\right)^{3/2}}\toinf\mathcal{O}(A)\cdot \frac{C_0^\Lambda}{\Lambda^3}\cdot a^{\frac{3}{2}}$  & $\frac{A\Lambda^2}{4A+A\mprime\frac{\Lambda^2}{a}}\toinf\frac{A}{A-1}\cdot a$ \\
2   & $
\frac{32 D_1^\Lambda a^3 A\mdprime A\mprime A^{3/2}}
{\left(16 a^2 A+4 a (3 A-1) \Lambda ^2+A\mdprime \Lambda ^4\right)^{3/2}}\toinf\mathcal{O}(A^2)\cdot \frac{D_1^\Lambda}{\Lambda^6}\cdot a^3$ &
$\frac{\Lambda ^2 \left(4 a^2 A+2 a A \Lambda ^2\right)}
{16 a^2 A+4 a (3 A-1) \Lambda ^2+A\mdprime \Lambda ^4}\toinf\frac{A}{A-2}\cdot 2a$ \\
3 & 
$\frac{32 D_1^\Lambda A\mdprime A\mprime}{\left(\frac{\left(4 a+\Lambda ^2\right) \left(4 a A+A\mdprime \Lambda ^2\right)}{a^2 A}\right)^{3/2}}\toinf\mathcal{O}(A^2)\cdot \frac{D_1^\Lambda}{\Lambda^6}\cdot a^3$ & $\frac{2 a A \Lambda ^2}{4 a A+A\mdprime \Lambda ^2}\toinf\frac{A}{A-2}\cdot 2a$ \\
\hline
$n$ & $\zeta_i$~[MeV$\cdot$fm$^{-3}$] & $\alpha_n$~[fm$^{-2}$] & $\beta_n$~[fm$^{-2}$] & $\gamma_n$~[fm$^{-2}$] \\
1 &$\frac{2 \sqrt{2}}{\left(\frac{A\mprime (A+1)^2}{a A^3}\right)^{3/2}}\to \mathcal{O}(1)\cdot a^{\frac{3}{2}}$&
$\frac{a \left(A^3+A\right)}{2 A\mprime (A+1)^2}\to\frac{1}{2}a$&
$\frac{2 a A^2}{A\mprime (A+1)^2}\to 2a$&
$\frac{a \left(A^3+A\right)}{2 A\mprime (A+1)^2}\to\frac{1}{2}a$\\
2 & 
$ \frac{8 C_0^\Lambda a^3 A\mprime A^{9/2}}{\pi ^{3/2} (A+1)^3 \left(4 a A\mprime+A\mdprime \Lambda ^2\right)^{3/2}}\toinf\mathcal{O}(A)\cdot \frac{C_0^\Lambda}{\Lambda^3}\cdot a^3$ & 
$\frac{\text{} a A \left(4 a \left(A^2+1\right)+\left(3 A^2+A+2\right) \Lambda ^2\right)}{2 (A+1)^2 \left(4 a A\mprime+A\mdprime \Lambda ^2\right)}\toinf \frac{3}{2}a$&
$\frac{4 \text{} a A^2 \left(2 a+\Lambda ^2\right)}{(A+1)^2 \left(4 a A\mprime+A\mdprime \Lambda ^2\right)}\toinf \mathcal{O}(A^{-1})\cdot4a$&
$\frac{a A \left(4 a \left(A^2+1\right)+\left(A^2-A+2\right) \Lambda ^2\right)}{2 (A+1)^2 \left(4 a A\mprime+A\mdprime \Lambda ^2\right)}$ \\
3 &
$\frac{32 D_1^\Lambda A\mdprime A\mprime (a A)^{9/2}}{\pi ^{3/2} (A+1)^3 \left(16 a^2 A\mprime+4 a (3 A-4) \Lambda ^2+A\mtprime \Lambda ^4\right)^{3/2}}\toinf\mathcal{O}(A^2)\cdot \frac{D_1^\Lambda}{\Lambda^6}\cdot a^{\frac{9}{2}}$&
$\frac{\text{} a A \left(16 a^2 \left(A^2+1\right)+4 a \left(5 A^2+A+4\right) \Lambda ^2+\left(5 A^2+2 A+3\right) \Lambda ^4\right)}{2 (A+1)^2 \left(16 a^2 A\mprime+4 a (3 A-4) \Lambda ^2+A\mtprime \Lambda ^4\right)}\toinf \frac{5}{2}a$&
$\frac{2 \text{} a A^2 \left(16 a^2+16 a \Lambda ^2+3 \Lambda ^4\right)}{(A+1)^2 \left(16 a^2 A\mprime+4 a (3 A-4) \Lambda ^2+A\mtprime \Lambda ^4\right)}\toinf \mathcal{O}(A^{-1})\cdot6a$&
...
4 &
$\frac{32 D_1^\Lambda A\mdprime A\mprime}{\pi ^{3/2} \left(\frac{(A+1)^2 \left(4 a+\Lambda ^2\right) \left(4 a A\mprime+A\mtprime \Lambda ^2\right)}{a^3 A^3}\right)^{3/2}}\toinf\mathcal{O}(A^2)\cdot \frac{D_1^\Lambda}{\Lambda^6}\cdot a^{\frac{9}{2}}$&
$\frac{\text{} a A \left(4 a \left(A^2+1\right)+\left(5 A^2+2 A+3\right) \Lambda ^2\right)}{2 (A+1)^2 \left(4 a A\mprime+A\mtprime \Lambda ^2\right)}\toinf \frac{5}{2}a$&
$\frac{2 \text{} a A^2 \left(4 a+3 \Lambda ^2\right)}{(A+1)^2 \left(4 a A\mprime+A\mtprime \Lambda ^2\right)}\toinf \mathcal{O}(A^{-1})\cdot6a$&
