...
\end{align}
The last line employs the assumption that the radius grows proportional to the volume of
$A$ spheres, \ie, $\propto A^{\frac{1}{3}}$. By ``SVM measuring'' $r_0$ for some $A$, we
