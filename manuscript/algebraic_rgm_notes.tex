...
\be
e^{-\gamma\ve{R}\cdot\ve{R}'}=4\pi\sum_{LM}i^Lj_L(i\gamma RR')Y^*_{LM}(\hat{\ve{R}})Y_{LM}(\hat{\ve{R}}')
\ee
...
(4\pi i^l)\cdot RR\mprime\cdot j_l(i\gamma_n RR')\cdot e^{-\alpha_n\ve{R}^2-\gamma_n\ve{R}'^2}~\psi(R\mprime)~d(R,R\mprime)\\
-(-E)\zeta_1\int\int
(4\pi i^l)\cdot RR\mprime\cdot j_l(i\gamma_1 RR')\cdot e^{-\alpha_1\ve{R}^2-\gamma_1\ve{R}'^2}~\psi(R\mprime)~d(R,R\mprime)\\
-\left(-\frac{\hbar}{2\mu}\right)\zeta_1\int\int
(4\pi) RR\mprime\cdot e^{-\alpha_n\ve{R}^2-\gamma_n\ve{R}'^2}~\psi_{lm}(R\mprime)
\cdot\Bigg\lbrace
(4\alpha_1^2R^2+\beta_1^2R\mprime^2-2\alpha_1) i^l j_{l}(i\gamma_1 RR')\\
+
(4\alpha_1\beta_1)\cdot RR\mprime\cdot
 \left(i^{l-1} j_{l-1}(i\gamma_1 RR') (2l-3)
 \threej{1}{l-1}{l}{0}{0}{0}^2+
 i^{l+1} j_{l+1}(i\gamma_1 RR') (2l-1)
