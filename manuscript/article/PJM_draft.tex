...
effective range $r_0$ being one of these. Furthermore, the scattering volume $a_p$ of the two-nucleon $P$-wave amplitude is
non-zero.
...
%Studying $\lc^A$ behavior with the non-universal parameter $B_3/B_2$ ... need 
...
2 & 4.81 & 2.30 \\
\end{tabular}
}{\caption{Minimal effective range required to stabilize the $2+2$ (dimer-dimer)
