...
yyunits = [float(cc[0]) for cc in list(lec_list_unitary_scatt.values())]
...
ax1.plot(xx15, yy15, 'r', label=r'$B(3/2)=1.5/1\,$MeV', alpha=0.4)
ax1.plot(xx, yyunits, 'r:', label=r'$B(3/2)=4/-\epsilon\,$MeV', alpha=0.4)
ax1.plot(xx, yy3, 'r--', label=r'$B(3/2)=3/1\,$MeV')
ax1.plot(xx, yy4, 'r', label=r'$B(3/2)=4/1\,$MeV', alpha=0.4)
ax1.legend(loc=0, fontsize=14)

#ax2.set_xscale('log')
ax2.set_yscale('log')
yyunits = [-float(cc[1]) for cc in list(lec_list_unitary_scatt.values())]
...
ax2.plot(xx15, yy15, 'm', label=r'$B(3/2)=1.5/1\,$MeV', alpha=1)
ax2.plot(xx, yyunits, 'b:', label=r'$B(3/2)=4/-\epsilon\,$MeV', alpha=0.4)
ax2.plot(xx, yy3, 'b--', label=r'$B(3/2)=3/1\,$MeV')
ax2.plot(xx, yy4, 'b', label=r'$B(3/2)=4/1\,$MeV', alpha=1)
